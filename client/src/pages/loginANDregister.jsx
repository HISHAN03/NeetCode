  ...
  return (
    <div className="bg-gradient h-screen flex flex-col items-center justify-center">
      ...
      <div className="bg-white p-10 rounded-lg border border-gray-300 bg-opacity-25">
        ...
        {loginError && (
          <div className="text-red-300 text-md mb-2">{loginError}</div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          {iSLoginOrRegister === 'login' && (
            <div>
              <button
                type="submit"
                className="bg-transparent text-gray-700 hover:bg-black-500 text-blue-dark font-semibold 
               hover:text-black py-2 px-4 border border-blue-dark hover:border-white rounded focus:outline-none focus:shadow-outline"
              >
                Login
              </button>
